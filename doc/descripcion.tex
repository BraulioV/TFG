...
Esto nos lleva a un nuevo problema que surge durante la generación de un nuevo horario, y es la gestión de aulas de las que dispone el centro. Esto es casi tan importante como la propia estructura del horario, ya que es tan importante que todos los grupos tengan aulas de teoría asignadas para poder cursar las horas de teoría que tenga cada asignatura, como las aulas de prácticas o laboratorios que existen para cursar estas horas de prácticas, como el no saturar ni las aulas de prácticas ni las de teoría, ya que esto llevaría a un mal funcionamiento del centro.
